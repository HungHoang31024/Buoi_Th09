...
(
 ...
 insert into NhanVien values ('NV01','Nguyen Mai','Ngoc','Nu','5/21/1975','22 CMT8, Q3','0344237723')
 insert into NhanVien values ('NV02','Le Van','Trung','Nam','5/26/1985','12 Hai Ba Trung, Q1','094518345')
 insert into NhanVien values ('NV03','Tran Thao','My','Nu','1/1/1990','44/5 Cao Thang, Q10','0864729028')
 insert into NhanVien values ('NV04','Nguyen Bich','Chi','Nu','12/20/1978','5/1/2 Le Loi, Q1','039392316')
 insert into NhanVien values ('NV05','Ha Anh','Dao','Nu','11/16/1991','16 Nguyen Trai, Q11','0997223145')
 insert into NhanVien values ('NV06','Nguyen Ngo Nhu','Quynh','Nu','09/02/2002','Phu Hoa, Thoai Son','0296444218')
 insert into NhanVien values ('NV07','Truong Hoang','Hung','Nam','09/03/2002','Phu Hoa, Thoai Son','0937475767')
 insert into NhanVien values ('NV08','Le Minh','Anh','Nam','09/01/2002','Phu Hoa, Thoai Son','0837523678')
